...
public class InterestDao extends AbstractDao<Interest, Long> {
    ...
    public static final String TABLENAME = "InterestTable";
    ...
    */
    public static class Properties {
        ...
        public final static Property DisplayOrder= new Property(++c, Long.class, 	DISPLAY_ORDER, 	false, DISPLAY_ORDER);
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL(Dao.CREATE_TABLE + constraint + Dao.Q + TABLENAME + Dao.Q + Dao.START_TABLE +
                ...
                Dao.Q + DISPLAY_ORDER       + Dao.Q + Dao.TYPE_INTEGER 			+ Dao.COMMA +
    ...
    protected void bindValues(SQLiteStatement stmt, Interest entity) {
        ...
        ++c; stmt.bindLong(c, entity.getDisplay_order());
    ...
    public void readEntity(Cursor cursor, Interest entity, int offset) {
        ...
        entity.setDisplay_order(cursor.getLong(offset + ++c));
