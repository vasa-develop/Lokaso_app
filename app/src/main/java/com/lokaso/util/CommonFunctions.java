...
public class CommonFunctions {
    ...
    private static String IST = "Asia/Calcutta";
    ...
    public static String formateDateTZ(String outputFormat, Date inputDate) {
        ...
        try {
            parsed = inputDate;
            df_output.setTimeZone(TimeZone.getTimeZone("IST"));
            outputDate = df_output.format(parsed);
    ...
    public static Boolean hasTimepassed(String time) {
        ...
        try {
            ...
            MyLog.e(TAG, current_time + "  " + check_time);
    ...
    public static String getTimeByIndianTimeZone(String outputFormat, String inputDate) {
        ...
        TimeZone timeZoneOther = TimeZone.getTimeZone(IST);

        MyLog.e(TAG, "TimeZone Device " + timeZone.getDisplayName());
        MyLog.e(TAG, "TimeZone Other " + timeZoneOther.getDisplayName());
