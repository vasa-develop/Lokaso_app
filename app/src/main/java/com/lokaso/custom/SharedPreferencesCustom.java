...
/**
 * Created by Androcid-6 on 13-02-2017.
 */
...
public class SharedPreferencesCustom {
     ...
     */
    public SharedPreferencesCustom(Context context, String preferenceName, String secureKey, boolean encryptKeys) throws SecurePreferencesException {
        try {
